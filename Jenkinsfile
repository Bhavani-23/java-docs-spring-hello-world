pipeline {
    ...
    stages {
        ...
        stage('command execution') {
            ...
            post {
                failure {
                    emailext body: "Please check the console output at $BUILD_URL for more information", to: "dhurgabavani.p@gmail.com", subject: '$PROJECT_NAME is failled - Build number is $BUILD_NUMBER and build status is $BUILD_STATUS'
                }
            }
        }
    }
